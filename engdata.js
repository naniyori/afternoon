...
cans[1][0]=2;
dreason[1][0]="Unless แปลว่า  เว้นแต่ว่า ";
cans[1][1]=3;
dreason[1][1]="Grey area=ไม่ชัดเจน";
cans[1][2]=1;
dreason[1][2]="In due time = soon = in due course/time= ในเวลาที่เหมาะสม สมควร";
cans[1][3]=1;
dreason[1][3]="Make a fuss = จู้จี้จุกจิก";
cans[1][4]=2;
dreason[1][4]="The early bird gets the worm.  “early bird” คือคนที่ทำอะไรเร็วกว่าคนอื่น,คนขยัน<br>Good things come to those who waits. = สิ่งดีๆจะมาให้คนอดทน<br>Better late than never. = สายดีว่าไม่มา<br>Look before you leap. = ดูดีๆก่อนทำ<br>";
cans[1][5]=3;
dreason[1][5]="หมายความว่า  มีเพียง2-3คนเข้าร่วมการสนทนาครั้งนี้";
cans[1][6]=1;
dreason[1][6]="หมายความว่า  สัตว์ผู้บริโภคซากพืชซากสัตว์บินลงมาตรงซากสัตว์ที่ตายแล้ว ใช้กรงเล็บจับมันบินขึ้นไปบนออากาศด้วยกัน";
cans[1][7]=2;
dreason[1][7]="well-dressed เป็น adj.ขยายนาม  ที่เกิดจาก adv.-V3 ";
cans[1][8]=2;
dreason[1][8]="Fawn แปลว่า ลูกกวาง";
cans[1][9]=4;
dreason[1][9]="The dead = คนตาย";
cans[1][10]=4;
dreason[1][10]="There was nothing + to + V1 ซึ่ง darn = ปัก";
cans[1][11]=1;
dreason[1][11]="Made ในที่นี้ เป็น V.ไม่แท้ ซึ่งเป็นแบบ V3 แปลว่า ถูกทำ";
cans[1][12]=4;
dreason[1][12]="Folded ในที่นี้เป็น V.ไม่แท้ สื่อว่า มือของเธอถูกพับไว้";
cans[1][13]=2;
dreason[1][13]="ถ้าเป็นการบอกสภาพ จะใช้ watch someone do something";
cans[1][14]=2;
dreason[1][14]="One of them เป็นเอกพจน์ และเป็ผนการเล่าเรื่องที่ผ่านมาแล้ว จึงใช้กริยา  was";
cans[1][15]=1;
dreason[1][15]="Go +to +V1";
cans[1][16]=3;
dreason[1][16]="It was possible for someone to do something.";
cans[1][17]=2;
dreason[1][17]="Keep on + V.ing";
cans[1][18]=3;
dreason[1][18]="หน้า and หลัง and ต้องเท่ากัน ซึ่งหน้า and ใช้ว่า standing ดังนั้น ต้องใช้ว่า laughing";
cans[1][19]=4;
dreason[1][19]="Lie lied lied = โกหก<br>Lay laid laid = วางไข่/วาง<br>Lie lay lain = นอน";
cans[1][20]=2;
dreason[1][20]="One man’s meat is another man’s poison แปลว่า สิ่งที่ดีสำหรับคนนึงอาจเป็นสิ่งที่เลวร้ายสำหรับอีกคนได้";
cans[1][21]=1;
dreason[1][21]="Dwindling แปลว่า เล็กลงไป";
cans[1][22]=3;
dreason[1][22]="จากบทกลอน ตีความได้ว่า ม้าแก่ตัวนี้กำลังมองดูเจ้านายของมันขี่ม้าอีกตัวออกไปสู่เมือง";
cans[1][23]=2;
dreason[1][23]="จากบทกลอน จะเห็นได้ว่า ม้าแก่ตัวนี้อยู่บนหุบเขาเล็กๆ";
cans[1][24]=3;
dreason[1][24]="Skyscrapers แปลว่า ตึกสูง";
cans[1][25]=1;
dreason[1][25]="On time = ตรงเวลา";
cans[1][26]=2;
dreason[1][26]="Industrious = ขยัน";
cans[1][27]=2;
dreason[1][27]="Prayer = ผู้สวดมนต์ แต่ข้ออื่น เกี่ยวกับ เครื่องบิน";
cans[1][28]=4;
dreason[1][28]="Vague = unclear = คลุมเครือ แต่ข้ออื่นแปลว่า เข้าใจได้, ชัดเจน";
cans[1][29]=2;
dreason[1][29]="ต้องแก้เป็น made เนื่องจาก ต้องใช้ make decision ไม่ใช่ do decision ";
cans[1][30]=3;
dreason[1][30]="แก้เป็น finishing เนื่องจาก เชื่อมโดย as much as กับคำว่า Writing จึงต้องใช้ V.ing เหมือนกัน";
cans[1][31]=1;
dreason[1][31]="แก้เป็น exhaustive ซึ่งแปลว่า complete / ละเอียดถี่ถ้วน";
cans[1][32]=2;
dreason[1][32]="แก้เป็น phenomenon เป็นนามเอกพจน์ เพราะใช้กริยา is";
cans[1][33]=2;
dreason[1][33]="แก้เป็น absolutely (adv.) ขยายคำว่า funny (adj.) ขยาย joke (n.)";
cans[1][34]=3;
dreason[1][34]="จากประโยคที่ว่า However, the main purpose of these evenings in the town is to discuss business. จะเห็นได้ว่า นักธุรกิจชาวญี่ปุ่นไปไนท์คลับเพื่อคุยเรื่องธุรกิจ";
cans[1][35]=4;
dreason[1][35]="เนื่องจากมีการเน้นไปที่คำว่า true change ในประโยคแรกจึงเป็นการสื่อว่า จะเป็นสิ่งที่น่าสนใจมากหากมีการเปลี่ยนแปลงที่แท้จริงเกิดขึ้นกับทัศนคติของคนญี่ปุ่นที่มีต่อการทำงานและเวลาว่าง";
cans[1][36]=2;
dreason[1][36]="จากประโยค Another activity that allows businesspeople to appear to relax while they are actually discussing is golf. จะตีความได้ว่า  จุดประสงค์หลักที่นักธุรกิจญี่ปุ่นไปเล่นกอล์ฟ คือ เพื่อไปคุยเรื่องงาน แต่อยากให้ดูสบายๆ";
cans[1][37]=1;
dreason[1][37]="Workaholics แปลว่า บ้างาน , compulsive แปลว่า จำเป็น/ต้องทำ";
cans[1][38]=4;
dreason[1][38]="เพราะ จาก Some people say that the Japanese seem to work hard at relaxing. “work hard at relaxing” หมายถึง พยายามอย่างมากอย่างสุดๆที่จะผ่อนคลาย";
cans[1][39]=2;
dreason[1][39]="topic sentence คือประโยคที่แสดง main idea ย่อหน้า  จึงตอบว่า  Cats have a long and interesting history.";
cans[1][40]=3;
dreason[1][40]="จากประโยคในบทความที่ว่า  The Egyptians worshiped cats. จึงตอบข้อ3";
cans[1][41]=4;
dreason[1][41]="เป็นการพูดเกี่ยวกับแมว จึงควรปรากฏใน Animal magazines";
cans[1][42]=2;
dreason[1][42]="จากประโยคที่ว่า The American Indians didn’t keep cats as pets. จึงทำให้ข้อ2 ผิด";
cans[1][43]=1;
dreason[1][43]="Prevented = ถูกป้องกัน";
cans[1][44]=3;
dreason[1][44]="Whenever = เมื่อไรก็ตาม";
cans[1][45]=2;
dreason[1][45]="Smoker = ผู้สูป ในที่นี้ heavy cigarettes smoker หมายถึง ผู้สูบบุหรี่อย่างหนัก";
cans[1][46]=2;
dreason[1][46]="Should have gone แปลว่า ควรจะไปแต่ไม่ได้ไป";
cans[1][47]=4;
dreason[1][47]="But she did nothing แปลว่า แต่เธอไม่ทำอะไรเลย";
cans[1][48]=3;
dreason[1][48]="Because of + N. แปลว่า  เพราะ";
cans[1][49]=4;
dreason[1][49]="Operation = การผ่าตัด<br>Management = การจัดการ<br>Imitation = การเลียนแบบ<br>Preparation = การเตรียมตัว";
